...
'End If
wscript.echo "This is an outdated version of ES Templates." & vbCRLF & "Please install the new templates (Revision 3) using 'Media & Communications Bulletin' Email sent on Jan 13, 2013" & vbCRLF & "Or call IT on Ext:2444 for help.."